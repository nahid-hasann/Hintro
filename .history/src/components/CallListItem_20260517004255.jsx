  ...
  return (
    <div className="flex items-center justify-between py-4 group hover:bg-slate-50/50 px-4 rounded-xl transition-colors">
      <div className="flex items-center gap-4">
        {/* Avatar Icon */}
        <div className="w-10 h-10 rounded-lg bg-[#8a38f5] flex items-center justify-center text-black font-normal">
          {call.client?.[0] || 'K'}
        </div>
        
        {/* Call Info */}
        <div>
          <h4 className="text-sm font-bold text-slate-900">{call.client || 'Design Call'}</h4>
      ...
      <div className="flex items-center gap-6">
        ...
        <button className="p-1.5 text-black  hover:bg-slate-100 rounded-lg transition-all">
