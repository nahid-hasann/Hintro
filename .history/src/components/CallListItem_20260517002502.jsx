  ...
  return (
    <div className="flex items-center justify-between py-4 group hover:bg-slate-50/50 px-4 rounded-xl transition-colors">
      <div className="flex items-center gap-4">
        {/* Avatar Icon */}
        <div className="w-[29px] h-[29px] rounded-lg bg-[#8a38f5] flex items-center justify-center text-white font-bold">
          {call.client?.[0] || 'K'}
        </div>
        
        {/* Call Info */}
        <div>
          <h4 className="text-[12px] md:text-[14px] font-bold text-slate-900">{call.client || 'Design Call'}</h4>
